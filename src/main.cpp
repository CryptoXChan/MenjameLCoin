...
// Copyright (c) 2013 MenjamelCoin developers
...
const string strMessageMagic = "MenjamelCoin Signed Message:\n";

double dHashesPerSec = 0.0;
int64 nHPSTimerStart = 0;

// Settings
int64 nTransactionFee = 0.000001*COIN;

static const int64 nStartSubsidy = 2000 * COIN;
static const int64 nMinSubsidy = 0.5 * COIN;

static const int64 nTargetTimespan = 120; // 2 minutes
static const int64 nTargetSpacing = 60; // 1 min
...
static const int64 nMaxAdjustDown = 60; // 60% adjustment down
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MenjamelCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MenjamelCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MenjamelCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running MenjamelCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MenjamelCoinMiner terminated\n");
        throw;
    }
}
