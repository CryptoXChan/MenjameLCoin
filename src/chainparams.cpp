...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "MenjameLCoin 2017 01 October Catalonia emerges as new state in Europe";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1506816061;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 76623;
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("menjamelcoin.test", "test.menjamelcoin.org"));
